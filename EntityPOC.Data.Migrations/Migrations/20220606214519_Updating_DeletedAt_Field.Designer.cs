...
namespace EntityPOC.Data.Migrations
{
    ...
    [Migration("20220606214519_Updating_DeletedAt_Field")]
    partial class Updating_DeletedAt_Field
    {
            ...
            modelBuilder.Entity("EntityPOC.Domain.Entities.Board", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1500,
                            CreatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 693, DateTimeKind.Utc).AddTicks(9524),
                            ...
                            Name = "Default - Board",
                            UpdatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 693, DateTimeKind.Utc).AddTicks(9897)
                        });
                });
            ...
            modelBuilder.Entity("EntityPOC.Domain.Entities.BoardColumn", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoardId = 1500,
                            Color = "Red",
                            CreatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 696, DateTimeKind.Utc).AddTicks(686),
                            Description = "Default backlog column",
                            Header = "Backlog",
                            Name = "To-Dos",
                            UpdatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 696, DateTimeKind.Utc).AddTicks(700)
                        },
                        new
                        {
                            Id = 1501,
                            BoardId = 1500,
                            Color = "Blue",
                            CreatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 696, DateTimeKind.Utc).AddTicks(1010),
                            Description = "Default Current column",
                            Header = "Current",
                            Name = "Working on",
                            UpdatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 696, DateTimeKind.Utc).AddTicks(1013)
                        },
                        new
                        {
                            Id = 1502,
                            BoardId = 1500,
                            Color = "Green",
                            CreatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 696, DateTimeKind.Utc).AddTicks(1015),
                            Description = "Default Done column",
                            Header = "Done",
                            Name = "Completed",
                            UpdatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 696, DateTimeKind.Utc).AddTicks(1016)
                        });
                });
            ...
            modelBuilder.Entity("EntityPOC.Domain.Entities.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoardColumnId = 1500,
                            CreatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 696, DateTimeKind.Utc).AddTicks(7272),
                            Description = "Test Description",
                            Image = "https://futbollibre.net/inicio/?tv",
                            Name = "Backog card 1",
                            Owner = "Reynaldo",
                            UpdatedAt = new DateTime(2022, 6, 6, 21, 45, 18, 696, DateTimeKind.Utc).AddTicks(7272)
                        },
                        new
                        {
                            Id = 1001,
